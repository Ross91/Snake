...
namespace Colors
{
	...
	static constexpr Color DarkGreen = MakeRGB(15u, 88u, 34u);
	static constexpr Color MedGreen = MakeRGB(32u, 158u, 64u);
	static constexpr Color LightGreen = MakeRGB(91u, 225u, 126u);
	static constexpr Color LightestGreen = MakeRGB(144u, 250u, 172u);
}